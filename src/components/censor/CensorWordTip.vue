    ...
    <el-collapse class="wordtips">
      <el-collapse-item name="txt-template">
        ...
        <el-text tag="p" style="margin-bottom: 1rem">
          ...
          级别没有实际作用，也不进行展示。不同词库中和同一词库中不同等级的重复词汇，将按照给定的
          <strong>最高级别</strong> 判断。<br />
          更多介绍见下：
        </el-text>
        <el-collapse accordion>
          <el-collapse-item>
            ...
            <el-text tag="p">
              使用 toml
              格式作为词库，支持填写便于分享的信息，如作者、版本、更新日期等。可以下载模板查看具体的属性（内含注释）。<br />
          ...
          <el-collapse-item>
            ...
            <el-text tag="p">
              ...
              <br />
              <em
                ><el-tag size="small" type="info" disable-transitions> #等级</el-tag
                >以下的词汇为该等级的敏感词，每一行代表一个词汇，直到遇到新的等级标记。</em
              >
            </el-text>
          </el-collapse-item>
        </el-collapse>
